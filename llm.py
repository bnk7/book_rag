...
def get_prompt(question: str, context: dict[str, str]) -> list[ChatMessage]:
    ...
    if context['author'] != None and context['genres'] != None and context['pub_date'] != None:
        ...
        $title was written by $author in $pub_date. It is a work of $genres. Here is a summary of $title: $summary
        ---
        Now here is the question you need to answer. 
        Question: $question""")
    elif context['author'] != None and context['genres'] != None:
        values['author'] = context['author']
        genres = list(context['genres'].values())
        if len(genres) > 1:
            values['genres'] = ', '.join(genres[:-1]) + ' and ' + genres[-1]
            ...
            values['genres'] = genres[0]
        prompt_template = Template("""Context:
        $title was written by $author. It is a work of $genres. Here is a summary of $title: $summary
        ---
        Now here is the question you need to answer. 
        Question: $question""")
    elif context['author'] != None and context['pub_date'] != None:
        values['author'] = context['author']
        values['pub_date'] = context['pub_date'][:4]
        prompt_template = Template("""Context:
        $title was written by $author in $pub_date. Here is a summary of $title: $summary
        ---
        Now here is the question you need to answer. 
        Question: $question""")
    elif context['genres'] != None and context['pub_date'] != None:
        genres = list(context['genres'].values())
        if len(genres) > 1:
            values['genres'] = ', '.join(genres[:-1]) + ' and ' + genres[-1]
        else:
        ...
        values['pub_date'] = context['pub_date'][:4]
        prompt_template = Template("""Context:
        $title was written in $pub_date. It is a work of $genres. Here is a summary of $title: $summary
        ---
        Now here is the question you need to answer. 
        Question: $question""")
    elif context['author'] != None:
        values['author'] = context['author']
        prompt_template = Template("""Context:
        $title was written by $author. Here is a summary of $title: $summary
        ---
        Now here is the question you need to answer. 
        Question: $question""")
    elif context['genres'] != None:
        genres = list(context['genres'].values())
        if len(genres) > 1:
            values['genres'] = ', '.join(genres[:-1]) + ' and ' + genres[-1]
        else:
            values['genres'] = genres[0]
        prompt_template = Template("""Context:
        $title is a work of $genres. Here is a summary of $title: $summary
        ---
        Now here is the question you need to answer. 
        Question: $question""")
    elif context['pub_date'] != None:
        values['pub_date'] = context['pub_date'][:4]
        prompt_template = Template("""Context:
        $title was written in $pub_date. Here is a summary of $title: $summary
        ---
        Now here is the question you need to answer. 
        Question: $question""")
    else:
        prompt_template = Template("""Context:
        Here is a summary of $title: $summary
        ---
        Now here is the question you need to answer. 
        Question: $question""")
